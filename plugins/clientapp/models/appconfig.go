...
type AppConfig struct {
	...
	ConfigKey         string     `gorm:"column:config_key;type:varchar(64);not null;default:default;comment:配置Key" json:"configKey"`
	...
	Extra             JSONString `gorm:"column:extra;type:text;comment:扩展配置" json:"extra"`
